...
{
	H_OnMessageReceived = new GlobalForward("CSM_OnMessageReceived", ET_Ignore, Param_String, Param_String, Param_String, Param_String, Param_String);
}
...
void CreateNatives()
{
	CreateNative("CSM_PostMessage", Native_PostMessage);
}
